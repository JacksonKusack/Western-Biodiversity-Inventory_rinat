...
Pull out species with <= 10 observations within Ontario. Note that I am only using the research grade observations here, but you could repeat this with the needs-id records too. The same theory applies 
